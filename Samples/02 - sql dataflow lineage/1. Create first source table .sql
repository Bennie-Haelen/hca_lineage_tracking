...
--
CREATE OR REPLACE TABLE `hca-sandbox.lineage_samples.facilities_sql` (
    facility_id INT64,
...
--
INSERT INTO `hca-sandbox.lineage_samples.facilities_sql` (facility_id, facility_name, city, state)
VALUES
